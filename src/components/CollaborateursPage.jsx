  ...
  return (
    <div className="space-y-5 pb-6">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-5">
        <Stat icon={Users} title="Total" value={totalCollaborateurs} color={{ bg: "bg-[#e8f0ff]", text: "text-[#0f63f2]" }} />
        <Stat icon={CheckCircle2} title="Qualifies" value={qualifiesCount} color={{ bg: "bg-[#e8f1fb]", text: "text-[#005ca9]" }} />
        <Stat icon={AlertCircle} title="En cours" value={enCoursCount} color={{ bg: "bg-[#fff2e4]", text: "text-[#fc6200]" }} />
        <Stat icon={XCircle} title="Non associee" value={nonAssocieeCount} color={{ bg: "bg-[#fdeeee]", text: "text-[#ea3737]" }} />
        <Stat icon={AlertTriangle} title="Depassement" value={depassementCount} color={{ bg: "bg-[#f3edff]", text: "text-[#7b35e8]" }} />
      </div>
        ...
        {isFiltersOpen ? (
          <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-3">
            <div className="space-y-2">
              <label htmlFor="collab-status-filter" className="text-sm font-medium text-[#252930]">
                {tr("Statut", "Status")}
              </label>
              <select
              ...
              >
                ...
                <option value="Non associee">{tr("Non associee", "Not associated")}</option>
                <option value="En cours">{tr("En cours", "In progress")}</option>
                <option value="Qualifie">{tr("Qualifie", "Qualified")}</option>
                <option value="Depassement">{tr("Depassement", "Overdue")}</option>
              </select>
            </div>

            <div className="space-y-2">
              <label htmlFor="collab-department-filter" className="text-sm font-medium text-[#252930]">
              ...
              >
                <option value="all">{tr("Tous les departements", "All departments")}</option>
