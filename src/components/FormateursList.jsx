...
const getSpecialites = (specialite) =>
  ...
  return (
    <div className="space-y-5 pb-6">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
        <Stat icon={GraduationCap} title="Total Formateurs" value={totalFormateurs} color={{ bg: "bg-[#f3edff]", text: "text-[#9029ff]" }} />
        <Stat icon={GraduationCap} title="Actifs" value={activeFormateurs} color={{ bg: "bg-[#e8f1fb]", text: "text-[#005ca9]" }} />
        <Stat icon={BookOpen} title="Formations assignees" value={totalAssignedFormations} color={{ bg: "bg-[#fff2e4]", text: "text-[#fc6200]" }} />
        <Stat icon={Mail} title="Avec contact" value={withContactInfo} color={{ bg: "bg-[#e8f0ff]", text: "text-[#0f63f2]" }} />
      </div>
