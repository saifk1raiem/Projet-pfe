...
export function HeuresPresenceChart() {
  ...
  return (
    <Card className="rounded-[20px] border border-[#dfe5e2] bg-white p-6 shadow-sm">
      <div className="mb-6">
        <h3 className="mb-1 text-[38px] font-medium text-[#1b1e23]">Heures de Présence Mensuelles</h3>
        <p className="text-[15px] text-[#5f6777]">Comparaison heures réelles vs objectifs</p>
      </div>
