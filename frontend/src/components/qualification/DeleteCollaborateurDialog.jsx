      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            {collaborateurToDelete
              ? tr(
                  `Cette action supprimera ${collaborateurToDelete.nom} ainsi que son historique de qualification.`,
                  `This will delete ${collaborateurToDelete.nom} and the related qualification history.`,
                )
