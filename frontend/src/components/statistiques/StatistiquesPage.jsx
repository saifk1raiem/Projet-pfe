        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            <h1 className="leoni-display-lg text-3xl font-semibold text-[#1d2a21] md:text-4xl">
              {tr("Statistiques", "Statistics")}
            </h1>
            <p className="max-w-2xl text-sm text-[#5f6d66] md:text-base">
              {tr(
                "Les statistiques seront bientot disponibles. Cette page reste volontairement vide pour le moment.",
                "Statistics are coming soon. This page is intentionally empty for now.",
              )}
            </p>
          </div>
        </div>
        ...
        <Card className="rounded-[28px] border border-[#dce8df] bg-white/92 p-8 shadow-[0_20px_60px_rgba(26,54,39,0.08)]">
          <div className="flex flex-col gap-4">
            ...
            <p className="max-w-2xl text-sm leading-6 text-[#627067]">
              {tr(
                "Le frontend des statistiques a ete retire en attente d'une nouvelle version.",
                "The statistics frontend has been removed pending a new version.",
              )}
            </p>
          </div>
        </Card>
